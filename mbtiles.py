...
command = 'docker run --name fulcrum-tiler --rm -v %s:/input -v %s:/output -v %s:/root/Documents/MapBox -it --entrypoint="" fulcrumapp/tiler:latest %s' % (input_path, output_path, app_path, run_command)
